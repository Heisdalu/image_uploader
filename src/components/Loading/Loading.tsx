...
const Loading = () => {
  return (
    <div className="flex justify-center items-center w-[100%] rounded-[10px] max-w-[400px] bg-[#fff] dark:bg-[#212936] dark:shadow-none h-[100px] p-[0.5rem] shadow-[6px_17px_39px_-14px_#E5E7EB]">
      <div className=" w-[100%] flex justify-center flex-col items-center space-y-[16px]">
        <h1 className="space-x-[5px]">
          <span className="font-medium text-black dark:text-white">
            Uploading,
          </span>
          <span className="text-[#4D5562]">
            please wait...
          </span>
        </h1>
